...
MATRIXOS_IMAGES_OUT_DIR="${MATRIXOS_IMAGES_OUT_DIR:-${MATRIXOS_DEV_DIR}/out/images}"
# Directory where temporary mounts are placed during the image generation phase.
MATRIXOS_IMAGES_MOUNT_DIR="${MATRIXOS_IMAGES_MOUNT_DIR:-${MATRIXOS_DEV_DIR}/out/mounts}"
