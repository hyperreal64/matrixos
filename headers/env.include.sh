...
MATRIXOS_OSTREE_KEEP_OBJECTS_YOUNGER_THAN="${MATRIXOS_OSTREE_KEEP_OBJECTS_YOUNGER_THAN:-1 month}"
...
MATRIXOS_GRUB_CFG_RELATIVE_EFI_PATH="${MATRIXOS_RELATIVE_EFI_BOOT_PATH}/grub.cfg"
# /efi/efi/ROOT ... is WAI.
